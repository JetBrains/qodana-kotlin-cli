...
`qodana-go`, `qodana-php`, `qodana-rust`, `qodana-ruby`, `qodana-ruby-3.2`, `qodana-ruby-3.4`, `qodana-cdnet`). One source of truth per image: a thin `docker/images/<slug>.dockerfile` + `<slug>.env`,
