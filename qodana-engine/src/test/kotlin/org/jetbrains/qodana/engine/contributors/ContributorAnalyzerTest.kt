...
class ContributorAnalyzerTest {
    @Test
    fun `analyze groups commits by author`() =
        runTest {
            val git =
                FakeGitClient(
                    logOutput =
    ...
    @Test
    fun `analyze filters bots by email`() =
        runTest {
            val git =
                FakeGitClient(
                    logOutput =
    ...
    @Test
    fun `analyze filters bots by username`() =
        runTest {
            val git =
                FakeGitClient(
                    logOutput =
    ...
    @Test
    fun `analyze includes bots when excludeBots is false`() =
        runTest {
            val git =
                FakeGitClient(
                    logOutput =
    ...
    @Test
    fun `analyze extracts project name from remote URL`() =
        runTest {
            val git =
                FakeGitClient(
    ...
    @Test
    fun `analyze returns empty on git failure`() =
        runTest {
    ...
    @Test
    fun `analyze sorts by commit count descending`() =
        runTest {
            val git =
                FakeGitClient(
                    logOutput =
    ...
    @Test
    fun `analyze skips malformed lines`() =
        runTest {
            val git =
                FakeGitClient(
                    logOutput =
    ...
    @Test
    fun `analyze filters noreply github emails`() =
        runTest {
            val git =
                FakeGitClient(
                    logOutput =
    ...
    @Test
    fun `analyze applies mailmap and merges contributors`(
        @TempDir repoDir: Path,
    ) = runTest {
        Files.writeString(
    ...
    @Test
    fun `analyze applies mailmap canonical name for same email`(
        @TempDir repoDir: Path,
    ) = runTest {
        Files.writeString(
            repoDir.resolve(".mailmap"),
...
private class FakeGitClient(
    ...
    override suspend fun log(
        ...
        if (logOutput != null) {
            ...
            Result.failure(RuntimeException("git not available"))
        }
