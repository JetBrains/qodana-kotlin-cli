...
class ProjectDetectorTest {
    @Test
    fun `isAndroidProject true when AndroidManifest exists`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `isAndroidProject false when no manifest`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `isAndroidProject false for nonexistent dir`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `containsUnityProjects true when both dirs and version file`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `containsUnityProjects true with asset file`(
        @TempDir dir: Path,
    ) {
        dir.resolve("Assets").createDirectories()
        dir.resolve("ProjectSettings").createDirectories()
    ...
    @Test
    fun `containsUnityProjects false when missing Assets`(
        @TempDir dir: Path,
    ) {
        dir.resolve("ProjectSettings").createDirectories()
    ...
    @Test
    fun `containsUnityProjects false when missing ProjectSettings`(
        @TempDir dir: Path,
    ) {
        dir.resolve("Assets").createDirectories()
        assertFalse(ProjectDetector.containsUnityProjects(dir))
    ...
    @Test
    fun `containsDotNetProjects true with sln`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `containsDotNetProjects true with csproj`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `containsDotNetProjects false for java project`(
        @TempDir dir: Path,
    ) {
        dir.resolve("src").createDirectories()
    ...
    @Test
    fun `containsDotNetFrameworkProjects true with net45`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `containsDotNetFrameworkProjects true with v4 version`(
        @TempDir dir: Path,
    ) {
        dir.resolve("App.csproj").writeText(
            """
    ...
    @Test
    fun `containsDotNetFrameworkProjects false with net6`(
        @TempDir dir: Path,
    ) {
        dir.resolve("App.csproj").writeText(
            """
    ...
    @Test
    fun `containsDotNetFrameworkProjects false when no csproj`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `readIdeaDir detects Java module`(
        @TempDir dir: Path,
    ) {
    ...
    @Test
    fun `readIdeaDir detects multiple languages`(
        @TempDir dir: Path,
    ) {
        dir.resolve(".idea").createDirectories()
    ...
    @Test
    fun `readIdeaDir returns empty when no idea dir`(
        @TempDir dir: Path,
    ) {
