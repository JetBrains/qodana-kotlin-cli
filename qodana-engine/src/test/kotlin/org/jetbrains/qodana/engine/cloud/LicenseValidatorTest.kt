...
class LicenseValidatorTest {
    ...
    @Test
    fun `validate returns license data on success`() =
        runTest {
            val http =
                LicenseFakeHttp(
                    mapOf(
    ...
    @Test
    fun `validate returns auth error on 401`() =
        runTest {
            val http =
                LicenseFakeHttp(
                    mapOf(
    ...
    @Test
    fun `validate returns auth error on 404`() =
        runTest {
            val http =
                LicenseFakeHttp(
                    mapOf(
    ...
    @Test
    fun `validate returns network error on 500`() =
        runTest {
            val http =
                LicenseFakeHttp(
                    mapOf(
    ...
    @Test
    fun `validate fails when endpoints fetch fails`() =
        runTest {
            val http =
                LicenseFakeHttp(
                    mapOf(
