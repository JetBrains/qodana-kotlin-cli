...
class SarifVersioningTest {
    ...
    @Test
    fun `getVersionDetails from git`() =
        runTest {
            val versioning = SarifVersioning(fakeGit())
            val details =
                versioning.getVersionDetails(
                    Path.of("/project"),
                    envRemoteUrl = null,
                    envBranch = null,
                    envRevision = null,
    ...
    @Test
    fun `env vars override git values`() =
        runTest {
            val versioning = SarifVersioning(fakeGit())
            val details =
                versioning.getVersionDetails(
    ...
    @Test
    fun `no git client returns empty values`() =
        runTest {
    ...
    @Test
    fun `ssh url without scheme gets ssh prefix`() =
        runTest {
    ...
    @Test
    fun `detached HEAD returns empty branch`() =
        runTest {
    ...
    @Test
    fun `git failure returns empty values`() =
        runTest {
            val failingGit =
                object : GitClient {
                    override suspend fun revParse(
