...
object ContainerUtils {
     ...
     */
    fun selectUser(image: String, userFromContext: String, defaultUser: String = getDefaultUser()): String {
    ...
    fun getDefaultUser(): String {
        ...
        val gid = try {
            ProcessBuilder("id", "-g").start().inputStream.bufferedReader().readText().trim()
        } catch (_: Exception) {
            "1000"
        }
        return "$uid:$gid"
     ...
     */
    fun encodeAuthToBase64(username: String, password: String, serverAddress: String = ""): String {
     ...
     */
    fun checkImage(image: String, currentVersion: String = Linters.RELEASE_VERSION): ImageCheckResult? {
