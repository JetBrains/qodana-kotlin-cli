...
data class IntellijLinterProperties(
    ...
    companion object {
        val JVM = IntellijLinterProperties(
            linter = Linters.JVM,
        ...
        val JVM_COMMUNITY = IntellijLinterProperties(
        ...
        val ANDROID = IntellijLinterProperties(
        ...
        val ANDROID_COMMUNITY = IntellijLinterProperties(
        ...
        val PHP = IntellijLinterProperties(
            linter = Linters.PHP,
        ...
        val PYTHON = IntellijLinterProperties(
        ...
        val PYTHON_COMMUNITY = IntellijLinterProperties(
        ...
        val JS = IntellijLinterProperties(
            linter = Linters.JS,
        ...
        val DOTNET = IntellijLinterProperties(
        ...
        val RUBY = IntellijLinterProperties(
            linter = Linters.RUBY,
        ...
        val CPP = IntellijLinterProperties(
            linter = Linters.CPP,
        ...
        val GO = IntellijLinterProperties(
            linter = Linters.GO,
        ...
        val RUST = IntellijLinterProperties(
            linter = Linters.RUST,
        ...
        val ALL = listOf(
            JVM, JVM_COMMUNITY, ANDROID, ANDROID_COMMUNITY,
            PHP, PYTHON, PYTHON_COMMUNITY, JS,
            DOTNET, RUBY, CPP, GO, RUST,
        )

        fun findByLinter(linter: Linter): IntellijLinterProperties? =
            ALL.find { it.linter == linter }

        fun findByProductInfoCode(code: String): IntellijLinterProperties? =
            ALL.find { it.productInfoJsonCode == code }
    }
}
